...
(ACCNO CHAR(4),CUST_NAME VARCHAR(15),LOAN_AMOUNT DECIMAL(10,2),INSTALLMENT INT,INT_RATE DECIMAL(10,2),START_DATE DATE,INTEREST DECIMAL(10,2));
DESCRIBE LOAN_ACCOUNTS;
ALTER TABLE LOAN_ACCOUNTS ADD COLUMN CATEGORY VARCHAR(1);
DESCRIBE  LOAN_ACCOUNTS;
INSERT INTO LOAN_ACCOUNTS(ACCNO,CUST_NAME,LOAN_AMOUNT,INSTALLMENT,INT_RATE,START_DATE) 
