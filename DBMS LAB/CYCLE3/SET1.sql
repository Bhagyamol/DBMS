...
insert into employe (ssn,ename,design,dno,doj,salary)values (1,'Aarav','HR',2,'2009-07-12',70000),
(2,'Bhagya','Admin',1,'2008-03-10',75000),
(3,'Christy','Sales',3,'2011-06-23',35000 ),
(4,'Divya','Production',5,'2018-09-29',32000 ),
(5,'Gopal','Production',5,'1995-06-21',35000 ),
(6,'Hima','Finance',4,'2002-04-01',51000),
(7,'Meenu','HR',5,'2002-04-01',49000),
(8,'Hima','Finance',4,'2002-04-01',45000);
SELECT * FROM employe;
