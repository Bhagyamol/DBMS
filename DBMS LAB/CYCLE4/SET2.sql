CREATE TABLE BRANCH(BID INT,BRANCH_NAME VARCHAR(25),BRANCH_CITY VARCHAR(25),ASSETS INT);
CREATE TABLE ACCOUNTS(ACCNO INT,BID INT,BALANCE INT);
CREATE TABLE DEPOSITOR(CID INT,ACCNO INT);
CREATE TABLE CUSTOMER(CID INT,CUSTOMER_NAME VARCHAR(25),CUSTOMER_STREET VARCHAR(25),CUSTOMER_CITY VARCHAR(25));
